	...
	<div class="row" style="margin-top: 10%;">
		...
		<div class="col-md-4 col-md-offset-4" style="background-color: white; padding: 2%">
			...
			<div class="w3-container" >
				<h2 style="margin-bottom: 8%;">Login As Admin</h2>
				<form action="{{ route('adminLoginPost') }}" method="post" enctype="multipart/form-data">
					{{csrf_field()}}
					...
					<button class="btn btn-success" type="submit" style="margin-bottom: 3%;">Login As Admin</button > 
