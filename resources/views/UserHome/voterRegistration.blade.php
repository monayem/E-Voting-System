...
<body>
	...
	<div class="row" style="margin-top: 5%;">
		...
		<div class="col-md-4">
			<div class="w3-card w3-container" style="background-color: #313842;color: white;height: 510px;vertical-align: middle;">
				<h3 style="margin-top: 40%;">Welcome !</h3>
				<h4 style="margin-top: 5%;">Apply as voter for upcoming councilor election</h4>
				<p style="margin-top: 5%;">Please provide valid information. Election Commission will verify this information and send an email.</p>
			</div>
		</div>
		...
		<div class="col-md-4">
			...
			<div class="w3-card w3-container" >
				<h2>Apply As Voter</h2>
				<p>For upcoming Councilor Election</p>
				<form action="{{ route('storeVoter') }}" method="post" enctype="multipart/form-data">
					{{csrf_field()}}
					...
					<button class="btn btn-success" type="submit" style="margin-bottom: 3%;">Apply As Voter</button >  
					<a class="btn btn-primary" style="margin-bottom: 3%;" href="{{ route('login',['type'=>'voter']) }}">Login</a>    
